...
module "jumphost" {
  source = "../../../../modules/aws-jumphost-instance"
...
#   owners = ["136693071363"] # Debian official AMI account
# }
...
#   subnet_id = data.terraform_remote_state.aaaops_vpc.outputs.public_subnets[0]
