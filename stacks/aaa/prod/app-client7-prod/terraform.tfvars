...
host_headers                = ["client7.aaa.com.au"] # must be unique for that env/loadbalancer. LB must also have https cert that covers the host (manually installed)
...
container_image  = "2345678901234.dkr.ecr.ap-southeast-2.amazonaws.com/client7" # should be the full docker image URI, minus the label - should match the ecr repo indicated above
