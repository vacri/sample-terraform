...
host_headers                = ["dev-client8.aaa.tools"] # must be unique for that env/loadbalancer. LB must also have https cert that covers the host (manually installed)
...
container_image  = "123456789012.dkr.ecr.ap-southeast-2.amazonaws.com/client8" # should be the full docker image URI, minus the label - should match the ecr repo indicated above
...
container_memory = "2GB" # use numbers rather than string for this entry - see variables.tf
