...
host_headers                = ["php-sandbox.aaa.tools"] # must be unique for that env/loadbalancer
alb_https_listener_priority = 750
create_s3_assets_bucket     = true

container_image = "123456789012.dkr.ecr.ap-southeast-2.amazonaws.com/php-sandbox" # should be the full docker image URI, minus the label
